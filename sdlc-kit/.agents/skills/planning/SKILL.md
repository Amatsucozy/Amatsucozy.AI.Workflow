---
name: planning
description: Write paired work and verification plans for an SDLC pipeline task after research. Use when drafting, revising, or splitting implementation phases and verification gates; not for ordinary informal planning.
---
...
Write both plans to disk and present them to the human during design. Obtain
approval before the first engineer dispatch unless existing user instructions
already authorize implementation of this concrete scope. Record the approval date in main.yaml's `approved`
