---
name: run-test
description: Run a requested .NET test scope through amtcz test_run and return a capped, structured failure report. Use for test requests and verification gates. Requires test_run and test_probe; reports results without fixing code.
---
...
on your own initiative. Discover the configured amtcz MCP operations and inspect their input schemas
