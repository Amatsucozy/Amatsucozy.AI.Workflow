---
name: requirements
description: Distill a user request or Jira ticket into an SDLC ticket and main.yaml task state. Use for pipeline intake and follow-up tasks before research or planning; not for ad-hoc questions or ordinary edits outside the pipeline.
---
...
source-format check, not a confidence check. Record the
